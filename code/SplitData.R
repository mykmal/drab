...
# Create 1/2, 1/2 splits and 1/3, 2/3 splits of the individuals
...
# Write the split expression data to new files
...
# Write the split covariate data to new files
...
# Write the lists of individuals in each split to new header files
