...
# Using all of the data, find the sample mean of the differences between model prediction errors
...
T_DRAB <- mean_differences_full / sqrt(mean(boot_variances) + training_var)
