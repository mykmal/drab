...
write.table(expression_part1, file = paste(out_path, "/part1.expression.txt", sep = ""), sep = "\t", quote = FALSE, row.names = FALSE)
write.table(expression_part2, file = paste(out_path, "/part2.expression.txt", sep = ""), sep = "\t", quote = FALSE, row.names = FALSE)
write.table(expression_part3, file = paste(out_path, "/part3.expression.txt", sep = ""), sep = "\t", quote = FALSE, row.names = FALSE)
write.table(covariates_part1, file = paste(out_path, "/part1.covariates.txt", sep = ""), sep = "\t", quote = FALSE, row.names = FALSE)
write.table(covariates_part2, file = paste(out_path, "/part2.covariates.txt", sep = ""), sep = "\t", quote = FALSE, row.names = FALSE)
write.table(covariates_part3, file = paste(out_path, "/part3.covariates.txt", sep = ""), sep = "\t", quote = FALSE, row.names = FALSE)
